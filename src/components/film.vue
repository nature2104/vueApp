...
export default {
    ...
    mounted(){
        ...
        /*this.$http.get(`/api/${request}?start=${Math.floor(Math.random()*10)}`)*/
      this.$get(`http://hlsapp.hand-china.com/hmap_dev//app/queryFunction?roleCode=ADMIN`,{})
      /*this.$post('http://hlsapp.hand-china.com/core/r/api?sysName=HLS_APP&apiName=version_update',{})*/
          .then((res)=>{
